 ...
 */
	function matchRoute($route, $url) {
		...
		#error_log("ROUTER=$route, $regexp, $names, $defaults ?= $url");
 ...
 */
	function url($url = null, $full = false) {
		...
		#error_log("PARMS=".print_r($params,true));
		...
		if (is_array($url)) {
			...
			#error_log("URLOUT2=".print_r($urlOut,true));
			...
			#error_log("URLOUT2=".print_r($output,true));
