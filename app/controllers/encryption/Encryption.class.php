...
class Encryption {
    ...
    function encryption ()
    {
        ...
        $this->scramble1 = '!#$%()*,-.0123456789;<=>ABCDEFG HIJKLMNOPQRSTUVWXYZ[]^_abcdefghijklmnopqrstuvwxyz|~!';
        $this->scramble2 = 'f^jAE]6s8BgP>d5w_794plGKuCy.Jx)HiQ!#$~(;LtmD<TcFV=okIOzU[2 q13hS%Ze|r-RMa,NvWYnb*0Xf';
		
		//$this->scramble1 = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 ";
		//$this->scramble2 = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ";
